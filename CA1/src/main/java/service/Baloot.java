...
public class Baloot {
    ...
    public void addCommodityToUserBuyList(String userId, String commodityId)
            throws NotExistentUser, NotExistentCommodity, AlreadyInBuyList, InStockZero {
    ...
    public void withdrawPayableAmount(User user) throws InsufficientCredit, NotInStock, QuntityIsNegative {
